...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/project-1-/project-1-.css">
...
<body>
    <main>
        <header>
            ...
            <div id = "logo">
            <img src = "http://localhost/project-1-/project-1-.png" alt = "Gitmag">
            </div>
        </header>
        <nav>
            <ul>
           ...
           <input type="submit" valuo = "Search">
           </form>
        </nav>
        <section id="content"> 
            <aside>
...
<article>
    <div class="caption">
        ...
        <ul>
            ...
            <li>Views : <span>1526 viem</span></li>
         </ul>
         <p>
         ...
         <a href="#">More...</a>
            ...
            <div class = "image">
            <img src="http://localhost/project-1-/download.png" alt="thsi is a post">
